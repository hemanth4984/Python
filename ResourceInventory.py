...
def lambda_handler(event, context):  
    ...
    ses_user = "hemanthkumarvadupu@outlook"
    ses_pwd = "********"
    ...
    filepath ='/tmp/PUC_AWS_Resources_' + date_fmt + '.csv'
    #Give your filename
    #mail("hemanthkumarvadupu@outlook.com","hemanth4984@gmail.com","PWC AWS Resources","PFA for the AWS resource of PWC account.",filepath)
    s3.Object('cicdapi', filename).put(Body=open(filepath, 'rb'))
